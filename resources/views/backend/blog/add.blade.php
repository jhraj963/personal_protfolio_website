  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-12">
        <div class="card card-info">
            ...
            <form class="form-horizontal" method="post" action="{{ url('admin/blog/add') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea type="text" name="description" class="form-control" placeholder="Type Your Blog Description"></textarea>
                        </div>
                    </div>
