...
Route::group(['middleware'=> 'admin'], function(){
    ...
    Route::get('admin/portfolio/edit/{id}', [PortfolioController::class, 'portfolio_edit']);
    Route::post('admin/portfolio/edit/{id}', [PortfolioController::class, 'portfolio_update']);
